...
var TileSource = module.exports = inherit(ImageSource, /** @lends TileSource prototype */ {
    ...
    getTile: function (x, y, zoom) {
        ...
        console.log('pixelBounds: ', pixelBounds, 'offset: ', offset, 'size: ', size, 'scale: ', scale, 'widht: ', width, 'height: ', height, 'tileX: ', tileX, 'tileY: ', tileY, 'tileW: ', tileW, 'tileH: ', tileH, 'sourceX: ', sourceX, 'sourceY: ', sourceY, 'sourceW: ', sourceW, 'sourceH: ', sourceH);
