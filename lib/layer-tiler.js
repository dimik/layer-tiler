...
*/
    ...
    getTileUrl: function (x, y, zoom) {
        // return util.format('/Users/dmk/Work/my-tiler/images/tiles/%s/%s-%s.%s', zoom, x, y, this._options.tileType);
        return util.format('/Users/dmk/Work/my-tiler/images/%s_%s-%s.%s', zoom, x, y, this._options.tileType);
    },
